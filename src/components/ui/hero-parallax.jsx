...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <div
      ref={ref}
      className="min-h-[380vh] py-40 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({ product, translate }) => {
  return (
    ...
    >
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-mondo-700">
        {product.title}
      </h2>
    </motion.div>
  )
